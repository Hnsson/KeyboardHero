...
//}
//
////// Handling character translation with consideration for Swedish layout
////char GetCharFromVKCode(UINT vkCode, UINT scanCode, bool lowerCase) {
////    HKL layout = GetKeyboardLayout(0); // Retrieve the layout of the thread
////
////    BYTE keyboardState[256];
////    if (!GetKeyboardState(keyboardState)) {
////        return '\0'; // Return null character if unable to get the state
////    }
////
////    // Flush the keyboard buffer by filling it with null characters
////    WCHAR charOutput[5] = { 0 };
////    ToUnicodeEx(vkCode, scanCode, keyboardState, charOutput, 4, 0, layout);
////
////    char resultChar = '\0'; // Default to null character if conversion fails
////    int result = ToUnicodeEx(vkCode, scanCode, keyboardState, charOutput, 4, 0, layout);
////
////    // Check for a valid character or dead key
////    if (result == 1) {
////        // Convert wide character to multi-byte character set
////        WideCharToMultiByte(CP_UTF8, 0, charOutput, -1, &resultChar, sizeof(resultChar), NULL, NULL);
////    }
////    else if (result > 1) {
////        // Handle cases where more than one character is generated
////        resultChar = charOutput[0];
////    }
////
////    // Convert to lowercase if specified
////    return lowerCase ? tolower(resultChar) : resultChar;
////}
//
//
...
int main() {
	...
	std::vector<std::string> sentence;
	std::string gameTitle, characterName;
